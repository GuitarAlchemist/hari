...
$thresholdCount = 20
$thresholdMin   = 30
if ($env:HARI_DIGEST_MID_COUNT -and $env:HARI_DIGEST_MID_COUNT -match '^\d+$') { $thresholdCount = [int]$env:HARI_DIGEST_MID_COUNT }
if ($env:HARI_DIGEST_MID_MIN   -and $env:HARI_DIGEST_MID_MIN   -match '^\d+$') { $thresholdMin   = [int]$env:HARI_DIGEST_MID_MIN }
